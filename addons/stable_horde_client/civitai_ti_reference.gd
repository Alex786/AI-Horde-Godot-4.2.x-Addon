...
@export var tis_refence_url: String = "https://civitai.com/api/v1/models?types=TextualInversion&sort=Highest%20Rated&primaryFileOnly=true&limit=100"


var ti_reference := {}
var ti_id_index := {}
var models_retrieved: bool = false
var nsfw: bool = true: set = set_nsfw
